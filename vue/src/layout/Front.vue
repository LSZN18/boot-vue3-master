    ...
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 400px; display: flex; padding-left: 30px">
        <div style="width: 50px">
          <img src="../assets/logo.jpg" alt="" style="width: 40px; position: relative; top: 10px; right: 0">
        </div>
        <div style="flex: 1; font-size: 20px; color: orangered; font-weight: bold">华南农业大学珠江学院班级社交系统</div>
      </div>
      <div style="flex: 1; display: flex">
        <el-menu :default-active="activePath" mode="horizontal" router style="border: none; height: 100%; width: 80%">
          <el-menu-item index="/front/home">首页</el-menu-item>
          <el-menu-item index="/front/im">聊天室</el-menu-item>
          <el-menu-item index="/front/goods">商城</el-menu-item>
          <el-menu-item index="/front/Video">视频风采</el-menu-item>
          <el-menu-item index="/front/Photo">照片墙</el-menu-item>
          <el-menu-item index="/front/files">文件库</el-menu-item>

        </el-menu>
        <div style="width: 40%">
          <el-input style="width: 200px" placeholder="搜索内容" v-model="name" clearable size="large"></el-input>
          ...
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item><div @click="router.push('/front/orders')">我的订单</div></el-dropdown-item>
