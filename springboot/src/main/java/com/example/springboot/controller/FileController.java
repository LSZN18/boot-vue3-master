...
//        byte[] bytes = file.getBytes();
    ...
    public Result findPage(
                           ...
                           @RequestParam Integer pageSize) {
        QueryWrapper<File> queryWrapper = new QueryWrapper<File>().orderByDesc("id");
        queryWrapper.in("type","jpeg","png","jpg","webp","ico");  // select * from  file where type = xxx
        return Result.success(fileService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    public Result findPage() {
        QueryWrapper<File> queryWrapper = new QueryWrapper<File>().orderByDesc("id");
        queryWrapper.notIn("type","jpeg","png","jpg","webp","ico");  // select * from  file where type = xxx
        return Result.success(fileService.page(new Page<>(), queryWrapper));
    }
    /**
     * 导出接口
     */
